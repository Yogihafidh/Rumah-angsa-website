...
function DateSelector({ settings, cabin, bookedDates }) {
  ...
  return (
    <div className="flex flex-col justify-between">
      ...
      <div className="flex sm:flex-row flex-col sm:gap-0 gap-5 items-center justify-between py-4 px-4 sm:px-8 text-white bg-primary-500 h-auto mx-2 my-2 rounded-xl text-center">
        <div className="flex items-baseline gap-6">
          ...
          {numNights ? (
            <>
              <p className="bg-primary-400 rounded-2xl px-3 py-2 text-xl sm:text-2xl">
